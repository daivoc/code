...
hr.star-light:after {
  /* background: #1c5779; /* #18bc9c; #8bc34a;  */ */
  /* color: white; */
}
hr.star-primary {
  border-color: #2c3e50;
...
#header .container {
  ...
  padding-bottom: 10px;
  color: white;
  background: #41576d; /* #004B98 #406c9a #1c5779; #18bc9c; #8bc34a;  */
}
...
#header .intro-text .name {
  display: block;
  font-family: auto; /* "Montserrat", "Helvetica Neue", Helvetica, Arial, sans-serif; */
...
#portfolio .portfolio-item .portfolio-link .caption {
  /* background: #1c5779; /* rgba(24, 188, 156, 0.9); */ */
  position: absolute;
  width: 100%;
  height: 100%;
  opacity: 0;
