...
$(document).ready(function(){
	...
	$('#btn_Schedule').click(function(){
		window.open("<?php echo G5_THEME_URL ?>/utility/scheduleBlock/index.php?bo_table=<?php echo $bo_table?>&wr_id=<?php echo $view['wr_id']?>&wr_subject=<?php echo $view['wr_subject']?>&w_netapp_serial=<?php echo $view['w_netapp_serial']?>","scheduleBlock_<?php echo $view['wr_id']?>", "width=600,height=500,scrollbars=no");
		return false;
	});
	$('#btn_Stream').click(function(){
		window.open("http://<?php echo $view['w_netapp_addr']?><?php echo $view['w_url_02'] ?>","Realtime_Zone_Stream", "width=640,height=360,scrollbars=no");
		return false;
	});
	$('#btn_Snapshot').click(function(){
		window.open("<?php echo G5_CU_UTIL_URL ?>/ecosFileTree/snapshotView.php?ID=<?php echo $view['w_netapp_serial']?>&wr_subject=<?php echo $view['wr_subject']?>","Shot_Tree_<?php echo $view['w_netapp_serial']?>", "width=800,height=400,scrollbars=no");
		return false;
	});
	$('#btn_Position').click(function(){
		window.open("<?php echo G5_THEME_URL ?>/utility/status/mapsInfo.php?myLatS=<?php echo $view['w_netapp_lat_s']?>&myLngS=<?php echo $view['w_netapp_lng_s']?>&myLatE=<?php echo $view['w_netapp_lat_e']?>&myLngE=<?php echo $view['w_netapp_lng_e']?>&wr_subject=<?php echo $view['wr_subject']?>","mapsLocation", "width=600,height=400,scrollbars=no");
		return false;
	});
	$('#btn_Events').click(function(){
		...
		$('#TheForm input[name="w_netapp_serial"]').val("<?php echo $view['w_netapp_serial']?>");
		$('#TheForm input[name="wr_subject"]').val("<?php echo $view['wr_subject']?>");
		window.open('', 'Event Log','width=600,height=400,scrollbars=no');
		f.submit();
		// window.open("<?php echo G5_CU_UTIL_URL ?>/systemExec/realtime_tail.php?w_netapp_serial=<?php echo $view['w_netapp_serial']?>&wr_subject=<?php echo $view['wr_subject']?>","Realtime_Log_<?php echo $view['w_netapp_serial']?>", "width=600,height=400,scrollbars=no");
		// return false;
	});
	$('#btn_Monitor').click(function(){
		window.open("http://<?php echo $_SERVER["SERVER_NAME"].":".($view['w_port_03']) ?>","Realtime_Zone_<?php echo $view['w_netapp_serial']?>", "width=600,height=500,scrollbars=no");
		return false;
	});
});
</script>
...
<input type="hidden" name="w_netapp_serial" value="" />
...
<article id="bo_v" class="container">
    ...
    <section id="bo_v_atc" class="">
		...
		<tbody>
		<tr>
			<th class="w_hide" scope="row"><label for="w_netapp_disable"></label></th>
			<td><?php echo $SK_BO_Disable[ITS_Lang]?><input type="checkbox" class="form-control" name="w_netapp_disable" id="w_netapp_disable" value="1" <?php echo $view[w_netapp_disable]?'checked':'';?> disabled title="Permanently Disable Sensor"></td>
			...
			<td><?php echo $SK_BO_Apply[ITS_Lang]?><input type="checkbox" class="form-control" name="w_netapp_reload" id="w_netapp_reload" value="1" <?php echo $view[w_netapp_reload]?'checked':'';?> disabled title="Restart Sensor when catch first event after save this"></td>
		</tr>
		</tbody>
		</table>
		<table class="table table-bordered">
		...
		<tr><?php // wr_subject ?>
			...
			<td>
				...
				<input type="text" name="w_netapp_serial" value="<?php echo $view['w_netapp_serial'] ?>" id="w_netapp_serial" readonly class="form-control input50P" size="50">
			</td>
		</tr>
		<tr><?php // w_netapp_model ?>
			<th scope="row" title="Title"><label for="w_netapp_model">Model /<br>Resolution</label></th>
			<td>
				...
				<?php // echo select_w_netapp_model($write['w_netapp_model']); ?>
				<input type="text" name="w_netapp_model" value="<?php echo $view['w_netapp_model'] ?>" id="w_netapp_model" readonly class="form-control input25P" size="50">
				<input type="text" name="w_opt_int_01" value="<?php echo $view['w_opt_int_01'] ?>" id="w_opt_int_01" readonly class="form-control input25P" size="50">
				<input type="text" name="w_opt_int_02" value="<?php echo $view['w_opt_int_02'] ?>" id="w_opt_int_02" readonly class="form-control input25P" size="50">
			</td>
		</tr>
		<tr><?php // w_netapp_desc  ?>
			<th scope="row" title="Title"><label for="w_netapp_desc">Description</label></th>
			<td>
				<input type="text" name="w_netapp_desc" value="<?php echo $view['w_netapp_desc'] ?>" id="w_netapp_desc" readonly class="form-control input100P" size="50" maxlength="255" placeholder="NetApp Description">
			</td>
		</tr>
		</tbody>
		</table>
		...
		<tr><?php // w_netapp_addr w_netapp_port w_netapp_serial ?>
			<th scope="row"><label for="w_netapp_addr">NetApp IP/Port</label></th>
			<td>
			<input type="text" name="w_netapp_addr" value="<?php echo $view['w_netapp_addr'] ?>" id="w_netapp_addr" readonly class="form-control input50P" size="50">
			<input type="text" name="w_netapp_port" value="<?php echo $view['w_netapp_port'] ?>" id="w_netapp_port" readonly class="form-control input50P" size="50">
			</td>
		</tr>
		<tr><?php // w_opt_char_01 w_opt_char_02 ?>
			<th scope="row"><label for="w_opt_char_01">Option</label></th>
			<td>
			<input type="text" name="w_opt_char_01" value="<?php echo $view['w_opt_char_01'] ?>" id="w_opt_char_01" readonly class="form-control input50P" size="50">
			<input type="text" name="w_opt_char_02" value="<?php echo $view['w_opt_char_02'] ?>" id="w_opt_char_02" readonly class="form-control input25P" size="50">
			<input type="checkbox" name="w_opt_tiny_01" value="1" <?php echo $view['w_opt_tiny_01']?'checked':'';?> id="w_opt_tiny_01" disabled class="form-control input25P" style="height: 30px;">
			</td>
		</tr>
		<tr><?php // w_port_01,2,3,4 ?>
			<th scope="row"><label for="w_port_">Access Port</label></th>
			<td>
			<input type="text" name="w_port_01" value="<?php echo $view['w_port_01'] ?>" id="w_port_01" readonly class="form-control input25P" size="50">
			<input type="text" name="w_port_02" value="<?php echo $view['w_port_02'] ?>" id="w_port_02" readonly class="form-control input25P" size="50">
			<input type="text" name="w_port_03" value="<?php echo $view['w_port_03'] ?>" id="w_port_03" readonly class="form-control input25P" size="50">
			<input type="text" name="w_port_04" value="<?php echo $view['w_port_04'] ?>" id="w_port_04" readonly class="form-control input25P" size="50">
			</td>
		</tr>
		<tr><?php // w_link_0 ?>
			<th scope="row"><label for="w_linked">Linked</br>SensorID</label></th>
			<td>
			<input type="text" name="w_link_01" value="<?php echo $view['w_link_01'] ?>" id="w_link_01" readonly class="form-control input50P" size="50">
			<input type="text" name="w_link_02" value="<?php echo $view['w_link_02'] ?>" id="w_link_02" readonly class="form-control input50P" size="50">
			<input type="text" name="w_link_03" value="<?php echo $view['w_link_03'] ?>" id="w_link_03" readonly class="form-control input50P" size="50">
			<input type="text" name="w_link_04" value="<?php echo $view['w_link_04'] ?>" id="w_link_04" readonly class="form-control input50P" size="50">
			</td>
		</tr>
		<tr><?php // w_url_01 w_url_02 ?>
			<th scope="row"><label for="w_url_0">NetApp<br>Image/Video</label></th>
			<td>
			<input type="text" name="w_url_01" value="<?php echo $view['w_url_01'] ?>" id="w_url_01" readonly class="form-control input50P" size="50">
			<input type="text" name="w_url_02" value="<?php echo $view['w_url_02'] ?>" id="w_url_02" readonly class="form-control input50P" size="50">
			<input type="text" name="w_url_03" value="<?php echo $view['w_url_03'] ?>" id="w_url_03" readonly class="form-control input50P" size="50">
			<input type="text" name="w_url_04" value="<?php echo $view['w_url_04'] ?>" id="w_url_04" readonly class="form-control input50P" size="50">
			</td>
		</tr>
