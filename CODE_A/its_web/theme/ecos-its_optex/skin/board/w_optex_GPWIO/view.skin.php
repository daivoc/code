...
$(document).ready(function(){
	...
	var setVal = "<?php echo $view['w_gpwio_group'] ?>";
	if (setVal) {
...
<input type="hidden" name="w_gpwio_serial" value="" />
...
<article id="bo_v" class="container">
    ...
    <section id="bo_v_atc" class="">
		...
		<tr class='w_default_tr'>
			<th class="w_hide" scope="row"><label for="w_gpwio_disable"></label></th>
			<td><?php echo $SK_BO_Disable[ITS_Lang]?><input type="checkbox" class="form-control" name="w_gpwio_disable" id="w_gpwio_disable" value="1" <?php echo $view[w_gpwio_disable]?'checked':'';?> disabled title="Permanently Disable GPWIO"></td>
		...
		<tr class='w_default_tr'>
			...
			<td>
				...
				<input type="text" name="w_gpwio_serial" value="<?php echo $view['w_gpwio_serial'] ?>" id="w_gpwio_serial" readonly class="form-control input50P" ></td>
			</td>
		</tr>
		<tr class='w_default_tr'>
			<th scope="row" title="Title"><label for="w_gpwio_desc">Desc./Linked</label></th>
			<td>
				<input type="text" name="w_gpwio_desc" value="<?php echo $view['w_gpwio_desc'] ?>" id="w_gpwio_desc" readonly class="form-control input50P">
		...
		<tr class='w_default_tr'>
			...
			<td>
				<input type="text" name="w_gpwio_status" value="<?php echo $event_status[$view['w_gpwio_status']] ?>" id="w_gpwio_status" readonly class="form-control input50P">
				<div class="input50P" style="text-align:center">
					<input class="form-control hide" type="text" name="w_gpwio_group" value="<?php echo $view['w_gpwio_group'] ?>" id="w_gpwio_group">
