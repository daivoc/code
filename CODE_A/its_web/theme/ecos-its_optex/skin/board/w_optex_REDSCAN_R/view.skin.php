...
$ipSplit = explode(".", $view['w_sensor_Addr']);
$nodeIn = $SYSTEM_nodeIn + $ipSplit[2] + $ipSplit[3]; 
...
$(document).ready(function(){
	...
	$('#btn_SensorURL').click(function(){
		window.open("http://<?php echo $view['w_system_ip'] ?>:<?php echo $view['w_sensor_Port'] + $view["wr_id"] ?>","REDSCAN_<?php echo $view['wr_id']?>", "width=600,height=500");
		return false;
	...
	$('#btn_Trace').click(function(){
		window.open("<?php echo G5_THEME_URL ?>/utility/status/rlsArea.php?nodeIn=<?php echo $nodeIn ?>&devideID=<?php echo $view['w_device_id']?>&sensorID=<?php echo $view['w_sensor_serial']?>&bo_table=<?php echo $bo_table?>&wr_id=<?php echo $view['wr_id']?>&subject=<?php echo $view['wr_subject']?>","<?php echo $view['wr_subject']?>", "width=600,height=400,scrollbars=no");
		return false;
	});
	$('#btn_Monitor').click(function(){
		// window.open("http://<?php echo $_SERVER["SERVER_NAME"].":".$nodeOut ?>","Realtime_Zone_<?php echo $view['w_sensor_serial']?>", "width=800,height=600,scrollbars=no");
		window.open("<?php echo G5_THEME_URL ?>/utility/status/rlsArea.php?nodeIn=<?php echo $nodeIn ?>&devideID=<?php echo $write['w_device_id']?>&sensorID=<?php echo $write['w_sensor_serial']?>", "Map Info","width=800,height=600,scrollbars=no");
		return false;
	});
	
	$('input:radio[name^="w_output1"]').each(function() {
		if ($(this).val() == "<?php echo $view['w_output1_group'] ?>") {
			$(this).attr("checked", true);
		}
	});
	$('input:radio[name^="w_output2"]').each(function() {
		if ($(this).val() == "<?php echo $view['w_output2_group'] ?>") {
			$(this).attr("checked", true);
		}
	});
	$('input:radio[name^="w_output3"]').each(function() {
		if ($(this).val() == "<?php echo $view['w_output3_group'] ?>") {
			$(this).attr("checked", true);
		}
	});
	$('input:radio[name^="w_output4"]').each(function() {
		if ($(this).val() == "<?php echo $view['w_output4_group'] ?>") {
			$(this).attr("checked", true);
		}
	});
});
...
<article id="bo_v" class="container">
	...
	<div class="its_version" style="float:left;color:silver;padding:4px 8px;font-size:8pt;"><?php echo get_w_program_info(G5_CU_PATH_RLS_R)[0]; ?></div>
	...
	<div>
		...
		<?php if ($view['w_opt94']) { ?>
		<input type="button" value="<?php echo $SK_BO_Sensor[ITS_Lang]?>" id="btn_SensorURL" class="btn btn-danger f_right">
		<?php } ?>
		<?php if ($view['w_url2']) { ?>
		...
		<!-- input type="button" value="<?php echo $SK_BO_Trace[ITS_Lang]?>" id="btn_Trace" class="btn btn-danger f_right" -->
	...
	<section id="bo_v_atc" class="col-md-10 col-md-offset-1">
		...
		<tr>
			...
			<td>MASQUERADE<input type="checkbox" class="form-control" name="w_opt94" id="w_opt94" value="1" <?php echo $view[w_opt94]?'checked':'';?> disabled title="Tuner"></td>
		<?php /*
			<td class="w_default_tr">허용주기고정<input type="checkbox" class="form-control" name="w_event_keepHole" id="w_event_keepHole" value="1"<?php echo $view[w_event_keepHole]?'checked':'';?> disabled title="Keep event hold cycle."></td>
			<td class="w_default_tr">동일위치고정<input type="checkbox" class="form-control" name="w_event_syncDist" id="w_event_syncDist" value="1" <?php echo $view[w_event_syncDist]?'checked':'';?> disabled title="Allow event that same distence."></td>
		*/ ?>			</tr>
		</tbody>
		</table>
		<table class="table table-bordered">
		...
		<tr class="w_default_tr">
			<th scope="row" title="Allowable Diameter"><label for="w_sensor_ignore">Object_Diameter<?php // echo $SK_BO_Allowable_Diameter[ITS_Lang]?></label></th>
			<td>
				<span id="w_sensor_ignoreSDisp"><?php echo ($view['w_sensor_ignoreS'])?$view['w_sensor_ignoreS']/10:'0' ?></span> ~ <span id="w_sensor_ignoreEDisp"><?php echo ($view['w_sensor_ignoreE'])?$view['w_sensor_ignoreE']/10:'0' ?></span> Cm<?php // echo $SK_BO_Cmeter[ITS_Lang]?>
			</td>
		</tr>
		<tr class="w_default_tr">
			<th scope="row" title="Limit Due(Sec)"><label for="w_event_holdTime">Event_Count<?php // echo $SK_BO_Event_Count[ITS_Lang]?></label></th>
			<td>
				<span id="w_event_holdTimeDisp"><?php echo $view['w_event_holdTime'] ?></span> <?php // echo $SK_BO_Times[ITS_Lang]?>
			</td>
		</tr>
		<tr class="w_hide">
			<th scope="row" title="Allow Area"><label for="w_sensor_allowZone">Allow_Area<?php // echo $SK_BO_Allow_Area[ITS_Lang]?></label></th>
			<td>
				<div>Allow</div>
				<?php echo get_sensing_zone($view['w_sensor_allowZone']); ?>
			</td>
		</tr>
		<tr class="w_hide">
			<th scope="row" title="Refuse Area"><label for="w_sensor_ignoreZone">Ignore_Area<?php // echo $SK_BO_Ignore_Area[ITS_Lang]?></label></th>
			<td>
				<div>Ignore</div>
				<?php echo get_sensing_zone($view['w_sensor_ignoreZone']); ?>
			</td>
		</tr>
		<tr class="w_hide">
		...
		<tr class="w_hide">
			...
			<td>
				<span id="w_event_pickTimeDisp"><?php echo $view['w_event_pickTime'] / 1000 ?></span> <?php echo $SK_BO_Second[ITS_Lang]?>
			</td>
		</tr>
		</tbody>
		</table>
		...
		<tr class="w_detail_tr">
			<th scope="row" title="Time Stamp"><label>License</label></th>
			<td>
				<input type="text" value="<?php echo $view['w_license'] ?>" class="form-control input100P" disabled >
			</td>
		</tr>
		...
		<tr class="w_hide">
			...
			<td>
				<?php // echo $view['w_system_ip'], ':', $view['w_system_port'] ?>
				<input type="text" value="<?php echo $view['w_system_ip'] ?>" class="form-control input50P" disabled >
				<input type="text" value="<?php echo $view['w_system_port'] ?>" class="form-control input50P" disabled >
			</td>
		</tr>
		<tr class="w_hide">
		...
		<tr class="w_detail_tr">
			...
			<td>
				<input type="text" value="<?php echo $view['w_host_Addr'] ?>" class="form-control input50P" disabled >
				<input type="text" value="<?php echo $view['w_host_Port'] ?>" class="form-control input50P" disabled >
			</td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_host_Addr2">Host2</label></th>
			<td>
				<input type="text" value="<?php echo $view['w_host_Addr2'] ?>" class="form-control input50P" disabled >
				<input type="text" value="<?php echo $view['w_host_Port2'] ?>" class="form-control input50P" disabled >
			</td>
		</tr>
		<tr class="w_hide">
			<th scope="row"><label for="w_tcp_Addr">Tcp</label></th>
			<td>
				<?php echo $view['w_tcp_Addr'], ':', $view['w_tcp_Port'] ?>
			</td>
		</tr>
		<tr class="w_hide">
		...
		<tr class="w_detail_tr">
			...
			<td>
				<input type="text" value="<?php echo $DEVICE_alert[$view['w_alert_Port']] ?>" class="form-control input50P" disabled >
				<input type="text" value="<?php echo $view['w_alert_Value'] ?>" class="form-control input50P" disabled >
			</td>
		</tr>
		<tr class="w_hide">
		...
		<?php include_once($board_skin_path.'/../w_include_audio/view_audio_field01.php'); ?>
		<?php include_once($board_skin_path.'/../w_include_audio/view_audio_field02.php'); ?>
		<?php include_once($board_skin_path.'/../w_include_audio/view_audio_field03.php'); ?>
		<?php include_once($board_skin_path.'/../w_include_audio/view_audio_field04.php'); ?>

		
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_alert_Port">Alarm</label></th>
			<td>
				<table style="font-size: 8pt;color: gray;width:100%;">
				<tr>
				...
				<tr class="ckboxGrp">
					...
					<td class="w_output">
						<input type="text" name="w_output1_value" value="<?php echo $view['w_output1_value'] ?>" disabled id="w_output1_value" style="width:40px;padding:2px;" class="form-control w_output">
					</td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output1[]" disabled value="0"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output1[]" disabled value="1"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output1[]" disabled value="2"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output1[]" disabled value="3"></td>
				</tr>
				<tr class="ckboxGrp">
					<td class="w_output">Relay Output 2</td>
					<td class="w_output">
						<input type="text" name="w_output2_value" value="<?php echo $view['w_output2_value'] ?>" disabled id="w_output2_value" style="width:40px;padding:2px;" class="form-control w_output">
					</td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output2[]" disabled value="0"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output2[]" disabled value="1"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output2[]" disabled value="2"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output2[]" disabled value="3"></td>
				</tr>
				<tr class="ckboxGrp">
					<td class="w_output">Relay Output 3</td>
					<td class="w_output">
						<input type="text" name="w_output3_value" value="<?php echo $view['w_output3_value'] ?>" disabled id="w_output3_value" style="width:40px;padding:2px;" class="form-control w_output">
					</td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output3[]" disabled value="0"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output3[]" disabled value="1"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output3[]" disabled value="2"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output3[]" disabled value="3"></td>
				</tr>
				<tr class="ckboxGrp">
					<td class="w_output">Relay Output 4</td>
					<td class="w_output">
						<input type="text" name="w_output4_value" value="<?php echo $view['w_output4_value'] ?>" disabled id="w_output4_value" style="width:40px;padding:2px;" class="form-control w_output">
					</td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output4[]" disabled value="0"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output4[]" disabled value="1"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output4[]" disabled value="2"></td>
					<td class="w_output cRadio"><input class="form-control" type="radio" name="w_output4[]" disabled value="3"></td>
				</tr>
				</table>
			</td>
		</tr>
