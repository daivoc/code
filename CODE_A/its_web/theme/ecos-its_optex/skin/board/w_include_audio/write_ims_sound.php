...
if($write['wr_2']){
	$audio_path = G5_CU_AUD_PATH.'/'.$write['wr_2'];
...
<tr class='w_detail_tr'>
	...
	<td>
			...
			$(function() {
				...
				$('.submit').on('click', function() {
					...
					if(file_data != undefined) {
						...
						$.ajax({
							type: 'POST',
							url: '<?php echo $board_skin_url."/../w_include_audio/ims_mp3_upload.php?filename=" ?>'+file_name,
							contentType: false,
							processData: false,
							data: form_data,
		...
		<input style='float:left;margin-left:4px;width:80px;text-align:right;' type="text" name="wr_3" value="<?php echo $write['wr_3'] ?>" id="wr_3" class='form-control' readonly placeholder='Second'>
