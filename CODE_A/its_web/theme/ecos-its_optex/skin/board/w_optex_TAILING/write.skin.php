...
<section id="bo_w" class="container">
	...
	<div class="tbl_wrap table-responsive">
		...
		<tr class='w_default_tr'>
			<th scope="row" title="Title"><label for="wr_subject">Title/<br>Description</label></th>
			<td>
		...
		<tr class='w_default_tr'>
			<th scope="row" title="USB Device ID"><label for="w_device_id">Device/ID</label></th>
			<td>
				<input type="text" name="w_device_id" value="<?php echo $write['w_device_id'] ?>" id="w_device_id" class="form-control input25P" placeholder="Device ID(0)">
		...
		<tr class='w_detail_tr'>
			<th scope="row" title="Sensor URL"><label for="w_sensor_url">Sensor URL</label></th>
			<td>
			<input type="text" name="w_sensor_url" value="<?php echo $write['w_sensor_url'] ?>" id="w_sensor_url" class="form-control input50P" placeholder="http, rtsp, rtp, stream file" size="50">
			</td>
		</tr>
		...
		<tr class='w_default_tr'>
			...
			<div class="selectPart">D2:<br><select name="w_face_direction_B" id="w_face_direction_B" class="form-control selectDir" placeholder="Direct" disabled>
			...
			<div class="selectPart">D3:<br><select name="w_face_direction_C" id="w_face_direction_C" class="form-control selectDir" placeholder="Direct" disabled>
			...
			<div class="selectPart">D4:<br><select name="w_face_direction_D" id="w_face_direction_D" class="form-control selectDir" placeholder="Direct" disabled>
		...
		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">Zone Setting</label></th>
			<td>
			...
			<span style="display:inline-grid;padding: 0 10px;vertical-align: top;"><label style="color:crimson;margin: unset;">Permit</label><input type="checkbox" class="form-control" name="w_allow_permit" id="w_allow_permit" value="1" <?php echo $write[w_allow_permit]?'checked':'';?> ></span>
		...
		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">Mask Primary</label></th>
			<td>
			...
			<span class='hide' style="display:inline-grid;padding: 0 10px;vertical-align: top;"><label style="color:crimson;margin: unset;">Use Mask</label><input type="checkbox" class="form-control" name="w_opencv_mask" id="w_opencv_mask" value="1" <?php echo $write[w_opencv_mask]?'checked':'';?> ></span>
			</td>
		</tr>

		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">Mask Secondary</label></th>
			<td>
		...
		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">Mask Third</label></th>
			<td>
		...
		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">Filter Limit</label></th>
			<td>
			...
			<div class="inputPart">Timeout:<br><input type="text" name="w_reset_interval" value="<?php echo $write['w_reset_interval'] ?>" id="w_reset_interval" class="form-control" placeholder="Sec. Ex:3.54" size="50"></div>
			</td>
		</tr>

		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">Tailing</label></th>
			<td>
			<div class="inputPart">Width Start:<br><input type="text" name="w_opencv_tail_x" value="<?php echo $write['w_opencv_tail_x'] ?>" id="w_opencv_tail_x" class="form-control" placeholder="w_opencv_tail_x" size="50"></div>
			<div class="inputPart">Width End:<br><input type="text" name="w_opencv_tail_w" value="<?php echo $write['w_opencv_tail_w'] ?>" id="w_opencv_tail_w" class="form-control" placeholder="w_opencv_tail_w" size="50"></div>
			<div class="inputPart">Height Start:<br><input type="text" name="w_opencv_tail_y" value="<?php echo $write['w_opencv_tail_y'] ?>" id="w_opencv_tail_y" class="form-control" placeholder="w_opencv_tail_y" size="50"></div>
			<div class="inputPart">Height End:<br><input type="text" name="w_opencv_tail_h" value="<?php echo $write['w_opencv_tail_h'] ?>" id="w_opencv_tail_h" class="form-control" placeholder="w_opencv_tail_h" size="50"></div>
			<div style="clear: both;"></div>
			<div class="inputPart">Limit Width:<br><input type="text" name="w_opencv_tail_over_x" value="<?php echo $write['w_opencv_tail_over_x'] ?>" id="w_opencv_tail_over_x" class="form-control" placeholder="w_opencv_tail_over_x" size="50"></div>
			<div class="inputPart">Limit Height:<br><input type="text" name="w_opencv_tail_over_y" value="<?php echo $write['w_opencv_tail_over_y'] ?>" id="w_opencv_tail_over_y" class="form-control" placeholder="w_opencv_tail_over_y" size="50"></div>
			<div class="inputPart">Limit Pixels:<br><input type="text" name="w_opencv_tail_pixel" value="<?php echo $write['w_opencv_tail_pixel'] ?>" id="w_opencv_tail_pixel" class="form-control" placeholder="w_opencv_tail_pixel" size="50"></div>
			</td>
		</tr>
		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">Pre Process</label></th>
			<td>
			...
			<div class="inputPart">Light Lv(%):<br><input type="text" name="w_opencv_grayLv" value="<?php echo $write['w_opencv_grayLv'] ?>" id="w_opencv_grayLv" class="form-control" placeholder="w_opencv_grayLv" size="50"></div>
			...
			<span style="display:inline-grid;padding: 0 10px;vertical-align: top;"><label style="color:crimson;margin: unset;">Tuner Mode</label><input type="checkbox" class="form-control" name="w_opencv_tuner" id="w_opencv_tuner" value="1" <?php echo $write[w_opencv_tuner]?'checked':'';?> ></span>
			<span style="display:inline-grid;padding: 0 10px;vertical-align: top;"><label style="color:crimson;margin: unset;">Multiple</label><input type="checkbox" class="form-control" name="w_allow_multiple" id="w_allow_multiple" value="1" <?php echo $write[w_allow_multiple]?'checked':'';?> ></span>
		...
		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">GPIO<br>Output/Timer</label></th>
			<td>
			...
			<div class="inputPart">Door Open:<br><input type="text" name="w_alert_Value1" value="<?php echo $write['w_alert_Value1'] ?>" id="w_alert_Value1" class="form-control" placeholder="Hold Time(Float)" size="50"></div>
			<div class="inputPart">Anti Denial:<br><input type="text" name="w_alert_Value2" value="<?php echo $write['w_alert_Value2'] ?>" id="w_alert_Value2" class="form-control" placeholder="Hold Time(Float)" size="50"></div>
			<div class="inputPart">Anti Tailing:<br><input type="text" name="w_alert_Value3" value="<?php echo $write['w_alert_Value3'] ?>" id="w_alert_Value3" class="form-control" placeholder="Hold Time(Float)" size="50"></div>
			<div class="inputPart">Alarm Event:<br><input type="text" name="w_alert_Value4" value="<?php echo $write['w_alert_Value4'] ?>" id="w_alert_Value4" class="form-control" placeholder="Hold Time(Float)" size="50"></div>
			</td>
		</tr>
		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">GPIO<br>Output/Init.<br>Input/Mode</label></th>
			<td>
		...
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_alert_Port">Group<br>Level</label></th>
			<td>
				<table>
				<tr class="ckboxGrp">
