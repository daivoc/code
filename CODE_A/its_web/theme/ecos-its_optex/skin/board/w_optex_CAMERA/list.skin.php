...
<section id="bo_list" class="container">
	...
	<div class="tbl_head01 tbl_wrap table-responsive">
		...
		<tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
			...
			<td class="board_CU"><?php echo $list[$i]['w_camera_model'] ?></td>
			...
			<td class="board_CU"><?php echo $list[$i]['w_camera_addr'] ?></td>
			<td class="board_CU"><?php echo $list[$i]['w_camera_serial'] ?></td>
			<!-- td class="board_CU"><?php echo $list[$i]['w_url1'] ?></td>
			<td class="board_CU"><?php echo $list[$i]['w_url2'] ?></td -->
			<?php
			if ($list[$i]['w_url1']) {
				$tmpUrl = "http://".$list[$i]['w_camera_addr'].$list[$i]['w_url1'];
				$tmpName = "<font color=green>".$SK_BO_Snapshot[ITS_Lang]."</font>";
			} else if ($list[$i]['w_url3']) {
				$tmpUrl = $list[$i]['w_url3'];
				$tmpName = "<font color=orange>".$SK_BO_Snapshot[ITS_Lang]."</font>";
			} else {
				$tmpUrl = "http://".$list[$i]['w_camera_addr'];
			...
			<?php
			if ($list[$i]['w_url2']) {
				$tmpUrl = "http://".$list[$i]['w_camera_addr'].$list[$i]['w_url2'];
				$tmpName = "<font color=green>".$SK_BO_Streaming[ITS_Lang]."</font>";
			} else if ($list[$i]['w_url4']) {
				$tmpUrl = $list[$i]['w_url4'];
