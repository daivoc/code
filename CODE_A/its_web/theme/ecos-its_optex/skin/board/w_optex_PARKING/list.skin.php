...
<section id="bo_list" class="container">
    ...
    <div class="tbl_head01 tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <th scope="col" style="width: 280px;"><?php echo $SK_BO_Serial_Number[ITS_Lang]?></th>
            <th scope="col"><?php echo $SK_BO_Sensor_Face[ITS_Lang]?></th>
            <th scope="col"><?php echo $SK_BO_Capacity[ITS_Lang]?>Capacity</th>
            <th scope="col"><?php echo $SK_BO_Current[ITS_Lang]?>Current</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_board"><?php echo $list[$i]['w_capacity_max'] ?></td>
            <td class="td_board"><?php echo $list[$i]['w_capacity_cur'] ?></td>
