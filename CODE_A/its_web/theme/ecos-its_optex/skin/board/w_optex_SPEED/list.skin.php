...
<section id="bo_list" class="container">
    ...
    <div class="tbl_head01 tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col" style="width: 200px;"><?php echo $SK_BO_Name[ITS_Lang]?></th>
            <th scope="col"><?php echo $SK_BO_Model_Name[ITS_Lang]?></th>
            <th scope="col" style="width: 200px;"><?php echo $SK_BO_Speed_Limit[ITS_Lang]?></th>
            <th scope="col"><?php echo $SK_BO_Event_Count[ITS_Lang]?></th>
<?php /*
            <th scope="col">허용감도-</th>
            <th scope="col">허용범주-</th>
            <th scope="col">경보주기-</th>
            <th scope="col">주기고정-</th>
            <th scope="col">거리고정-</th>
            <th scope="col">즉시적용-</th>
            <th scope="col">로그출력-</th>
...
*/?>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_board"><?php echo $list[$i]['w_sensor_ignoreZone'] ?></td>
...
<?php /*
            ...
            <td class="td_board"><?php echo $list[$i]['w_sensor_spot'] ?></td>
            <td class="td_board">
				<?php 
					if ($list[$i]['w_alert_Port'] && $list[$i]['w_alert_Value']) {
						echo $list[$i]['w_alert_Value'];
					} else {
						echo "Off";
					}
				?>
...
*/?>
            ...
            <td class="td_board pointer" onclick='window.open("http://<?php echo $_SERVER["SERVER_NAME"].":".$list[$i]['w_table_PortOut'] ?>","Realtime_Zone_<?php echo $list[$i]['w_sensor_serial']?>", "width=1140,height=240,scrollbars=no");' >Zone</td>
