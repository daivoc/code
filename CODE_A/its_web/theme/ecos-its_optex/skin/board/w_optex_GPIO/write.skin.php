    ...
    <div class="tbl_wrap table-responsive">
		...
		<tr class="w_default_tr">
			...
			<td>
				...
				<input class="form-control input20P w_hLvl" type="text" name="hold_1" value="<?php echo $holdTime["1"] ?>" id="w_1_holdTime" readonly placeholder="Level 1">
				<input class="form-control input20P w_hLvl" type="text" name="hold_2" value="<?php echo $holdTime["2"] ?>" id="w_2_holdTime" readonly placeholder="Level 2">
				<input class="form-control input20P w_hLvl" type="text" name="hold_3" value="<?php echo $holdTime["3"] ?>" id="w_3_holdTime" readonly placeholder="Level 3">
				<input class="form-control input20P w_hLvl" type="text" name="hold_4" value="<?php echo $holdTime["4"] ?>" id="w_4_holdTime" readonly placeholder="Level 4">
				<input class="form-control input20P w_hLvl" type="text" name="hold_5" value="<?php echo $holdTime["5"] ?>" id="w_5_holdTime" readonly placeholder="Level 5">
				...
				<input class="form-control input20P w_pLvl" type="text" name="pick_1" value="<?php echo $pickTime["1"] ?>" id="w_1_pickTime" readonly placeholder="Level 1">
				<input class="form-control input20P w_pLvl" type="text" name="pick_2" value="<?php echo $pickTime["2"] ?>" id="w_2_pickTime" readonly placeholder="Level 2">
				<input class="form-control input20P w_pLvl" type="text" name="pick_3" value="<?php echo $pickTime["3"] ?>" id="w_3_pickTime" readonly placeholder="Level 3">
				<input class="form-control input20P w_pLvl" type="text" name="pick_4" value="<?php echo $pickTime["4"] ?>" id="w_4_pickTime" readonly placeholder="Level 4">
				<input class="form-control input20P w_pLvl" type="text" name="pick_5" value="<?php echo $pickTime["5"] ?>" id="w_5_pickTime" readonly placeholder="Level 5">
