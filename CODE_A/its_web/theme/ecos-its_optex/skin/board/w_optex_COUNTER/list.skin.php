...
<section id="bo_list" class="container">
    ...
    <div class="tbl_head01 tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <th scope="col"><?php echo $SK_BO_Port[ITS_Lang]?></th>
            <th scope="col"><?php echo $SK_BO_Events[ITS_Lang]?>(<?php echo $SK_BO_Times[ITS_Lang]?>)</th>
            <th scope="col"><?php echo $SK_BO_Event_Hold[ITS_Lang]?>(<?php echo $SK_BO_Second[ITS_Lang]?>)</th>
            <th scope="col">동일신호</th>
            <th scope="col"><?php echo $SK_BO_Pause[ITS_Lang]?></th>
            ...
            <th scope="col"><?php echo $SK_BO_Restart[ITS_Lang]?></th>
            <th scope="col">로그</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_board">
				<?php if ($list[$i]['w_sensor_reload']) echo "On"; else echo "Off"; ?>
				<?php if ($is_checkbox) { ?>
					<input type="text" name="w_sensor_reload[]" value="<?php echo $list[$i]['w_sensor_reload'] ?>">
				<?php } ?>
			</td>
