...
table_BSS = c.ECOS_table_prefix+c.ECOS_table_BSS

def get_sensor_serial_BSS(): # Optex Microwave
	query = "SELECT wr_id, wr_subject, w_sensor_serial, w_email_Addr FROM " + table_BSS + " WHERE w_sensor_disable = 0 AND w_email_Addr != ''" 
	try:
