...
PS3="Select : "
select yn in "Apple[20.09]" "Banana[21.05]" "Cherry[ITS_PKG]" "Dinosaur[Next]" 
do
	echo ""
	echo ">>> Selected $yn <<<"
	echo ""
	if [ $yn == 'Apple[20.09]' ]; then
		downloadFolder="optex_PKG";
		break
	elif [ $yn == 'Banana[21.05]' ]; then
		downloadFolder="ecos_ITS_Download";
		break
	elif [ $yn == 'Cherry[ITS_PKG]' ]; then
		downloadFolder="ITS_PKG";
		break
	elif [ $yn == 'Dinosaur[Next]' ]; then
		downloadFolder="ECOS_PKG_01";
		break
	else
		exit 1
	fi
...
# downloadFolder="ECOS_PKG_01"; # Dinosaur(Next)
# downloadFolder="ITS_PKG"; # Cherry(Now)
# downloadFolder="ecos_ITS_Download"; # Banana(21.05)
# downloadFolder="optex_PKG"; # Apple(20.09)
...
# sshpass -pits_iot scp pi@$itsSrvRemote:/home/pi/$downloadFolder/code/common/config.json /home/pi/common;
