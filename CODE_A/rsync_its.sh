...
function its_GPIO {
	...
	if [ -d "/home/pi/$homeName/its_GPIO" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./GPIO/ /home/pi/ITS_PKG/code/GPIO >/dev/null 2>&1
...
function its_GPWIO {
	...
	if [ -d "/home/pi/$homeName/its_GPWIO" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./GPWIO/ /home/pi/ITS_PKG/code/GPWIO >/dev/null 2>&1
...
function its_API {
	...
	if [ -d "/home/pi/$homeName/its_API" ]; then
		...
		mkdir -p ./API
		# rm ./API/*.pyc
		cp config.json camera.json run itsAPI.pyc run_itsAPI.pyc itsAPI.js itsAPI.html itsAPI.php run_streaming.pyc streaming.pyc quickGuide.pdf QnA.pdf example.html ./API/ > /dev/null

		rsync -avzr --delete --exclude='node_modules' ./API/ /home/pi/ITS_PKG/code/API >/dev/null 2>&1
...
function its_GPACU {
	...
	if [ -d "/home/pi/$homeName/its_GPACU" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./GPACU/ /home/pi/ITS_PKG/code/GPACU >/dev/null 2>&1
...
function its_FRAME {
	...
	if [ -d "/home/pi/$homeName/its_FRAME" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./FRAME/ /home/pi/ITS_PKG/code/FRAME >/dev/null 2>&1
...
function its_SRF {
	...
	if [ -d "/home/pi/$homeName/its_partner/its_SRF" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./SRF/ /home/pi/ITS_PKG/code/SRF >/dev/null 2>&1
...
function its_FSI {
	...
	if [ -d "/home/pi/$homeName/its_partner/its_FSI" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./FSI/ /home/pi/ITS_PKG/code/FSI >/dev/null 2>&1
...
function its_GIKENP {
	...
	if [ -d "/home/pi/$homeName/its_partner/its_GIKENP" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./GIKENP/ /home/pi/ITS_PKG/code/GIKENP >/dev/null 2>&1
...
function its_GIKENC {
	...
	if [ -d "/home/pi/$homeName/its_partner/its_GIKENC" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./GIKENC/ /home/pi/ITS_PKG/code/GIKENC >/dev/null 2>&1
...
function its_GIKENT {
	...
	if [ -d "/home/pi/$homeName/its_partner/its_GIKENT" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./GIKENT/ /home/pi/ITS_PKG/code/GIKENT >/dev/null 2>&1
...
function its_TAILING {
	...
	if [ -d "/home/pi/$homeName/its_TAILING" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./TAILING/ /home/pi/ITS_PKG/code/TAILING >/dev/null 2>&1
...
function optex_BSS {
	...
	if [ -d "/home/pi/$homeName/its_optex/optex_BSS" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./optex_BSS/ /home/pi/ITS_PKG/code/optex_BSS >/dev/null 2>&1
...
function optex_RLS_R {
	...
	if [ -d "/home/pi/$homeName/its_optex/optex_RLS_R" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./optex_RLS_R/ /home/pi/ITS_PKG/code/optex_RLS_R >/dev/null 2>&1
...
function optex_SPEED {
	...
	if [ -d "/home/pi/$homeName/its_optex/optex_SPEED" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./optex_SPEED/ /home/pi/ITS_PKG/code/optex_SPEED >/dev/null 2>&1
...
function its_CAM {
	...
	if [ -d "/home/pi/$homeName/its_CAM" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./CAM/ /home/pi/ITS_PKG/code/CAM >/dev/null 2>&1
...
function its_MONITOR {
	...
	if [ -d "/home/pi/$homeName/its_MONITOR" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./MONITOR/ /home/pi/ITS_PKG/code/MONITOR >/dev/null 2>&1
...
function its_utility {
	...
	if [ -d "/home/pi/$homeName/its_utility" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./utility/ /home/pi/ITS_PKG/code/utility >/dev/null 2>&1
...
function its_common {
	...
	if [ -d "/home/pi/$homeName/its_common" ]; then
		...
		rsync -avzr --delete --exclude='node_modules' ./common/ /home/pi/ITS_PKG/code/common >/dev/null 2>&1
...
PS3="Select : "
select yn in "API" "GPIO" "GPACU" "GPWIO" "SRF" "FSI" "FRAME" "GIKENP" "GIKENT" "GIKENC" "TAILING" "BSS" "RLS_R" "SPEED" "CAM" "MONITOR" "Utility" "Common" "WEB" 
do
	echo ""
	echo ">>> $homeName ${ipListS[@]} <<<"
	echo ""
	...
	# echo "rsync -avzr --delete --exclude='.git' /home/pi/ITS_PKG pi@119.207.126.79:~"
	echo "rsync --progress -avzr --exclude='.*' /home/pi /optex/"
	echo "sshpass -p 'its_iot' rsync --progress -avzr --delete --exclude='.*' /home/pi/ITS_PKG pi@192.168.0.8:~"
	# rsync --progress -avzr --exclude='.*' /home/pi /optex/
done	
