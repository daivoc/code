...
<hr> -->
<a href='http://<?php echo $_SERVER['SERVER_NAME'].":".$cfg["interface"]["portMasq"]?>' class='button' id='sensor'>Sensor Config</a>
<a href='http://<?php echo $_SERVER['SERVER_NAME'].":".$cfg["interface"]["portAPIWEB"]?>' class='button' id='sensor'>API Monitering</a>
</div>
</body>
</html>