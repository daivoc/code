...
// $root_path = '/var/www/html/its_web/data/image/g200t210_192_168_0_201_0004';
$root_path = '/var/www/html/its_web/__current_path__';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
// $root_url = '';
// $root_url = 'data/image/g200t210_192_168_0_201_0004';
$root_url = '__current_path__';
...
<th>파일명</th><th style="width:10%">크기</th>
<th style="width:12%">생성일</th>
<?php if (!FM_IS_WIN): ?>
<th style="width:6%; display:none;">Perms</th>
<th style="width:10%; display:none;">Owner</th><?php endif; ?>
<th style="width:13%; display:none;"></th></tr>
<?php
...
<?php if (!FM_IS_WIN): ?>
<td style="display:none;"><a title="Change Permissions" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;chmod=<?php echo urlencode($f) ?>"><?php echo $perms ?></a></td>
<td style="display:none;"><?php echo fm_enc($owner['name'] . ':' . $group['name']) ?></td>
<?php endif; ?>
...
<p class="path" style="display:none;">
<a href="#" onclick="select_all();return false;"><i class="icon-checkbox"></i> Select all</a> &nbsp;
<a href="#" onclick="unselect_all();return false;"><i class="icon-checkbox_uncheck"></i> Unselect all</a> &nbsp;
<a href="#" onclick="invert_all();return false;" style="display:none;"><i class="icon-checkbox_invert"></i> Invert selection</a></p>
<p style="text-align: right;">
<input type="submit" name="delete" value="삭제" onclick="return confirm('Delete selected files and folders?')">
<input type="submit" name="zip" value="압축" onclick="return confirm('Create archive?')">
<input style="display:none;" type="submit" name="copy" value="Copy">
</p>
</form>
...
#wrapper{max-width:600px;min-width:400px;margin:10px auto}
...
.preview-img{width:100%;background:url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAKklEQVR42mL5//8/Azbw+PFjrOJMDCSCUQ3EABZc4S0rKzsaSvTTABBgAMyfCMsY4B9iAAAAAElFTkSuQmCC") repeat 0 0}
...
.break-word{word-wrap:break-word; display:none;}
</style>
...
{
    ?>
<p class="center" style="display:none;"><small><a href="https://github.com/alexantr/filemanager" target="_blank">PHP File Manager</a></small></p>
</div>
<script>
