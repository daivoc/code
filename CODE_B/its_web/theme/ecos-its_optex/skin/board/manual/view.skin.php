...
<article id="bo_v" class="container">
	...
	<header class="panel-heading">
		...
		<pre><?php echo $view['w_sub_title']; ?></pre>
		<?php echo '<span class="btn btn-xs btn-default">'.$view['w_group_main'].'</span>'; ?>
		<?php echo '<span class="btn btn-xs btn-default">'.$view['w_group_sub'].'</span>'; ?>
		<?php echo '<span class="btn btn-xs btn-default">'.$view['w_order'].'</span>'; ?>
	</header>
