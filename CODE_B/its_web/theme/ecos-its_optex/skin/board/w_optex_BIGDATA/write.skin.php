	...
	$(function() {
		$("#slider-range_w_event_holdTime").slider({ // 참조 https://jqueryui.com/slider/#rangemax
			...
			slide: function(event, ui) {
				...
				$("#w_event_holdTimeDispSec").text(Math.ceil((ui.value * <?php echo $Event_read_cycle ?>) * 10)/10);
			}
		});
		$("#w_event_holdTimeDisp").text($("#w_event_holdTime").val());
		$("#w_event_holdTimeDispSec").text(Math.ceil(($("#w_event_holdTime").val() * <?php echo $Event_read_cycle ?>) * 10)/10);
	});
	...
	$(function() {
		$("#slider-range_w_opt22").slider({ // 참조 https://jqueryui.com/slider/#rangemax
			...
			slide: function(event, ui) {
				...
				$("#w_opt22DispSec").text(Math.ceil((ui.value * <?php echo $Event_read_cycle ?>) * 10)/10);
			}
		});
		$("#w_opt22Disp").text($("#w_opt22").val());
		$("#w_opt22DispSec").text(Math.ceil(($("#w_opt22").val() * <?php echo $Event_read_cycle ?>) * 10)/10);
	});
    ...
    <div class="tbl_wrap table-responsive">
		...
		<tr class="w_default_tr">
			...
			<td>
				...
				<span id="w_event_holdTimeDisp"></span><?php echo $SK_BO_Times[ITS_Lang]?> (<?php echo $SK_BO_About[ITS_Lang]?><span id="w_event_holdTimeDispSec"></span><?php echo $SK_BO_Second[ITS_Lang]?>)
				...
				<div class="input50P" style="padding: 10px;">
				<span id="w_event_pickTimeDisp"></span> <?php echo $SK_BO_Second[ITS_Lang]?> (5~60<?php echo $SK_BO_Second[ITS_Lang]?>)
