<?php
// 필드 존재여부에 따라 세롭개 생성 {
$sql = " SELECT * FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = '".G5_MYSQL_DB."' AND TABLE_NAME = '".$write_table."' AND COLUMN_NAME = 'w_gpacu_serial' ";
// echo $sql."\n";
// exit();
...
ADD `w_gpacu_serial` varchar(32) DEFAULT NULL,
ADD `w_gpacu_desc` varchar(128) DEFAULT NULL,
ADD `w_gpacu_status` tinyint(4) NOT NULL DEFAULT '0',
ADD `w_gpacu_cover` varchar(16) DEFAULT NULL,
ADD `w_gpacu_group` varchar(16) DEFAULT NULL,
ADD `w_gpacu_disable` tinyint(1) NOT NULL DEFAULT '0',
