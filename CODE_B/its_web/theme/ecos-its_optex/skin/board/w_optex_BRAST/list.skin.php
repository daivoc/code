...
<section id="bo_list" class="container">
    ...
    <div class="tbl_head01 tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <th scope="col" style="width: 200px;"><?php echo $SK_BO_Detect_Range[ITS_Lang]?>(m)</th>
            <th scope="col"><?php echo $SK_BO_Event_Count[ITS_Lang]?></th>
            <th scope="col"><?php echo $SK_BO_Sensitivity[ITS_Lang]?></th>
            <th scope="col"><?php echo $SK_BO_Accept_Range[ITS_Lang]?></th>
            <th scope="col"><?php echo $SK_BO_Alarm_Cycle[ITS_Lang]?></th>
            ...
            <th scope="col"><?php echo $SK_BO_Monitor[ITS_Lang]?></th>
