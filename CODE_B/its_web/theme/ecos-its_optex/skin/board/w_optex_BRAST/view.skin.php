...
<article id="bo_v" class="container">
	...
	<div class="its_version" style="float:left;color:silver;padding:4px 8px;font-size:8pt;"><?php echo get_w_program_info(G5_CU_PATH_BSS)[0]; ?></div>
    ...
    <section id="bo_v_atc" class="col-md-10 col-md-offset-1">
		...
		<tr>
			...
			<td>
				<?php echo select_w_sensor_model($view['w_sensor_model'], 1); ?>
			</td>
		</tr>
		<tr>
		...
		<tr class="w_default_tr">
			<th scope="row" title="Alarm Level"><label for="w_sensor_spot"><?php echo $SK_BO_Accept_Range[ITS_Lang]?></label></th>
			<td>
		...
		<tr class="w_detail_tr">
			<th scope="row" title="Time Stamp"><label for="w_license">License</label></th>
			<td>
		...
		<tr class="w_hide">
			<th scope="row" title="ITS IP"><label for="w_systemBF_ip">ITS BF IP</label></th>
			<td>
				<?php echo $view['w_systemBF_ip'] ?> : <?php echo $view['w_systemBF_port'] ?>
			</td>
		</tr>
		<tr class="w_hide">
			<th scope="row" title="ITS IP"><label for="w_systemAF_ip">ITS AF IP</label></th>
			<td>
