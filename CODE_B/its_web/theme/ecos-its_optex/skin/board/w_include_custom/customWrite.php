...
<tr class="w_detail_tr">
	...
	<td>
        ...
        <input type='text' class='form-control wr8_Group' id='wr8_Port' value='<?php echo $wr8_Port; ?>' placeholder='34001'>
        ...
        <input type='text' class='form-control wr9_Group' id='wr9_Port' value='<?php echo $wr9_Port; ?>' placeholder='34001'>
