...
<section id="bo_list" class="container">
    ...
    <div class="tbl_head01 tbl_wrap table-responsive">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_board"><?php echo $DEVICE_input[$list[$i]['w_device_id']] ?></td>
            ...
            <td class="td_board pointer" onclick='window.open("<?php echo G5_CU_UTIL_URL ?>/systemExec/realtime_tail.php?w_sensor_serial=<?php echo $list[$i]['w_sensor_serial']?>&wr_subject=<?php echo $list[$i]['wr_subject']?>","Realtime_Log_<?php echo $list[$i]['w_sensor_serial']?>", "width=600,height=400,scrollbars=no");' ><?php echo $SK_BO_Log[ITS_Lang]?></td>
