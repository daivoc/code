...
ADD `w_sensor_allowZone` text DEFAULT NULL,
ADD `w_sensor_ignoreZone` text DEFAULT NULL,
...
ADD `w_alert3_Port` int(11) NOT NULL DEFAULT '0',
ADD `w_alert3_Value` float NOT NULL DEFAULT '0',
ADD `w_alert4_Port` int(11) NOT NULL DEFAULT '0',
ADD `w_alert4_Value` float NOT NULL DEFAULT '0',
...
ADD `w_audio1_name` varchar(128) DEFAULT NULL,
ADD `w_audio2_name` varchar(128) DEFAULT NULL,
ADD `w_audio3_name` varchar(128) DEFAULT NULL,
ADD `w_audio4_name` varchar(128) DEFAULT NULL,
ADD `w_audio1_time` float NOT NULL DEFAULT '0',
ADD `w_audio2_time` float NOT NULL DEFAULT '0',
ADD `w_audio3_time` float NOT NULL DEFAULT '0',
ADD `w_audio4_time` float NOT NULL DEFAULT '0',
ADD `w_audio1_volume` int(11) NOT NULL DEFAULT '0',
ADD `w_audio2_volume` int(11) NOT NULL DEFAULT '0',
ADD `w_audio3_volume` int(11) NOT NULL DEFAULT '0',
ADD `w_audio4_volume` int(11) NOT NULL DEFAULT '0',
ADD `w_anglePanO` float NOT NULL DEFAULT '0',
ADD `w_anglePanA` float NOT NULL DEFAULT '0',
ADD `w_anglePanB` float NOT NULL DEFAULT '0',
ADD `w_angleTiltO` float NOT NULL DEFAULT '0',
ADD `w_angleTiltA` float NOT NULL DEFAULT '0',
ADD `w_angleTiltB` float NOT NULL DEFAULT '0',
ADD `w_distanceO` float NOT NULL DEFAULT '0',
ADD `w_distanceA` float NOT NULL DEFAULT '0',
ADD `w_distanceB` float NOT NULL DEFAULT '0',
ADD `w_zoomO` float NOT NULL DEFAULT '0',
ADD `w_zoomA` float NOT NULL DEFAULT '0',
ADD `w_zoomB` float NOT NULL DEFAULT '0',
ADD `w_ptzX` float NOT NULL DEFAULT '0',
ADD `w_ptzY` float NOT NULL DEFAULT '0',
ADD `w_ptzH` float NOT NULL DEFAULT '0',
ADD `w_ptzA` float NOT NULL DEFAULT '0',
ADD `w_ptzCamURL` varchar(128) DEFAULT NULL,
ADD `w_ptzCamENC` tinyint(1) NOT NULL DEFAULT '0',
ADD `w_keycode` varchar(64) DEFAULT NULL,
ADD `w_stamp` TIMESTAMP DEFAULT CURRENT_TIMESTAMP";
sql_query($sql, false);
}

// ALTER TABLE `g5_write_g200t210` DROP `w_sensor_ignoreZone`;
// ALTER TABLE `g5_write_g200t210` ADD `w_sensor_allowZone` varchar(512) DEFAULT NULL AFTER `w_sensor_offset`;
// ALTER TABLE `g5_write_g200t210` ADD `w_sensor_ignoreZone` varchar(512) DEFAULT NULL AFTER `w_sensor_allowZone`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio1_name` varchar(128) DEFAULT NULL  AFTER `w_output4_group`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio2_name` varchar(128) DEFAULT NULL  AFTER `w_audio1_name`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio3_name` varchar(128) DEFAULT NULL  AFTER `w_audio2_name`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio4_name` varchar(128) DEFAULT NULL  AFTER `w_audio3_name`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio1_time` float NOT NULL DEFAULT '0'  AFTER `w_audio4_name`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio2_time` float NOT NULL DEFAULT '0'  AFTER `w_audio1_time`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio3_time` float NOT NULL DEFAULT '0'  AFTER `w_audio2_time`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio4_time` float NOT NULL DEFAULT '0'  AFTER `w_audio3_time`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio1_volume` int(11) NOT NULL DEFAULT '0'  AFTER `w_audio4_time`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio2_volume` int(11) NOT NULL DEFAULT '0'  AFTER `w_audio1_volume`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio3_volume` int(11) NOT NULL DEFAULT '0'  AFTER `w_audio2_volume`;
// ALTER TABLE `g5_write_g200t210` ADD `w_audio4_volume` int(11) NOT NULL DEFAULT '0'  AFTER `w_audio3_volume`;
