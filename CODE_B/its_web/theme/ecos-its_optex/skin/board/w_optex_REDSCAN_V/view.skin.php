...
<article id="bo_v" class="container">
	...
	<section id="bo_v_atc" class="col-md-10 col-md-offset-1">
		...
		*/ ?>			</tr>
		...
		<?php include_once($board_skin_path.'/../w_include_custom/customView.php'); // ITS API Interface ?>
		<?php include_once($board_skin_path.'/../w_include_custom/requestView.php'); // Http Request ?>
