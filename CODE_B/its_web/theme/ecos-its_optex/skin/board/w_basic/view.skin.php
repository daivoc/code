...
<article id="bo_v" class="container">
    ...
    <section id="bo_v_atc" class="col-md-10 col-md-offset-1">
		...
		<tr>
			...
			<td>
				<?php echo $view['w_sensor_baud'] ?>
			</td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_sensor_timeout">Serial Time Out</label></th>
			<td><?php echo $view['w_sensor_timeout'] ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="w_sensor_ignore">Ignore Zone</label></th>
			<td>
				<?php echo $view['w_sensor_ignore'] ?>
			</td>
		</tr>
		<tr>
			<th scope="row"><label for="w_sensor_face">Sensor Face</label></th>
			<td>
				<?php echo $view['w_sensor_face'] ?>
			</td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_sensor_angle">Sensor Angle</label></th>
			<td><?php echo $view['w_sensor_angle'] ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="w_sensor_lat_s">Latitude_S</label></th>
			<td><?php echo $view['w_sensor_lat_s'] ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="w_sensor_lng_s">Longitude_S</label></th>
			<td><?php echo $view['w_sensor_lng_s'] ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="w_sensor_lat_e">Latitude_E</label></th>
			<td><?php echo $view['w_sensor_lat_e'] ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="w_sensor_lng_e">Longitude_E</label></th>
			<td><?php echo $view['w_sensor_lng_e'] ?></td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_sensor_validLv">Due Level</label></th>
			<td><?php echo $view['w_sensor_validLv'] ?></td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_alarm_enable">Alarm Enable</label></th>
			<td><?php echo $view['w_alarm_enable'] ?></td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_alarm_level">Alarm Level</label></th>
			<td><?php echo $view['w_alarm_level'] ?></td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_stamp">Time Stamp</label></th>
			<td><?php echo ($view['w_stamp']) ?></td>
		</tr>
		<tr class="w_api_tr">
			<th scope="row"><label for="w_api_devId">API ID</label></th>
			<td><?php echo $view['w_api_devId'] ?></td>
		</tr>
		<tr class="w_api_tr">
			<th scope="row"><label for="w_api_devPass">API Password</label></th>
			<td><?php echo $view['w_api_devPass'] ?></td>
		</tr>
		<tr class="w_api_tr">
			<th scope="row"><label for="w_api_gwId">API Gateway ID</label></th>
			<td><?php echo $view['w_api_gwId'] ?></td>
		</tr>
		<tr class="w_api_tr">
			<th scope="row"><label for="w_api_ipAddr">API IP</label></th>
			<td><?php echo $view['w_api_ipAddr'] ?></td>
		</tr>
		<tr class="w_api_tr">
			<th scope="row"><label for="w_api_ipPort">API Port</label></th>
			<td><?php echo $view['w_api_ipPort'] ?></td>
		</tr>
		<tr class="w_api_tr">
			<th scope="row"><label for="w_api_tagId">API Tag ID</label></th>
			<td><?php echo $view['w_api_tagId'] ?></td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_host_ip">Host IP</label></th>
			<td><?php echo $view['w_host_ip'] ?></td>
		</tr>
        </tbody>
        </table>
    </section>
