...
$sql = "UPDATE $write_table 
	SET 
		...
		w_device_model = '$w_device_model',
		w_device_ip = '$w_device_ip',
		w_device_port = '$w_device_port',
		w_device_masq = '$w_device_masq',
		w_event_id = '$w_event_id',
		w_event_value = '$w_event_value',
		w_event_type = '$w_event_type',
