...
$cfg = json_decode(file_get_contents('/home/pi/API3/itsAPI.json'), true);
...
function json_validate($string) {
	...
	if ($error !== '') {
		...
		file_put_contents('/var/www/html/its_web/data/log/API3/API.log', '[From api.php] '.$error.PHP_EOL, FILE_APPEND | LOCK_EX);
