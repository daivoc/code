...
function event_zone_OBJ(id, name, status) {
	io.sockets.emit('message_to_client', { id: id, name: name, status: status });
}

		
app.listen(portOut); // Display server
console.log('Service server running at http://localhost:'+portOut+'/');
