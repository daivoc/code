...
///////////////////////////////////////////////////////////////////////////////
var configName = '/home/pi/optex_RLS_V/config_'+process.argv[2]+'.json';
...
// Html 파일, Client
///////////////////////////////////////////////////////////////////////////////
var html = fs.readFileSync('/home/pi/optex_RLS_V/realtime_RLS_'+portIn+'.html', 'utf8');
// var html = fs.readFileSync('/home/pi/optex_RLS_V/realtime_RLS_'+portIn+'_IMS.html', 'utf8');
...
function saveConfigJson() {
	fs.writeFile('/home/pi/optex_RLS_V/config_'+portIn+'.json', JSON.stringify(cfg, null, 4), (err) => {
		if (err) throw err;
...
function updateMask() {
	...
	var sql = "UPDATE "+cfg.table.rls_v+" SET w_sensor_allowZone='"+allowZone.replace(/,\s*$/, '')+"', w_sensor_ignoreZone='"+ignoreZone.replace(/,\s*$/, '')+"' WHERE wr_id="+cfg.sensor.tableID;
