...
<?php if($num_rows) { // 자료가 존재 하면 ?>
	...
	function drawChart() {
		...
		var chartCalendar = new google.visualization.Calendar(document.getElementById('calendar_basic'));
		// var options = { 
		...
		chartCalendar.draw(dataTable, options);
	} // 카렌다차트
	</script>
	<script type="text/javascript">
	...
	function drawSeriesChart() {
		...
		var chartBubble = new google.visualization.BubbleChart(document.getElementById('bubble_chart'));
		
		chartBubble.draw(data_all, options);
	} // 버블차트 
	</script>
...
<section class="success" id="header" style="padding:0;">
    <div class="container" style="padding:100px 0 0 0;">
        <div class="intro-text">
            <span class="name wow fadeInDown shadow" data-wow-delay=".5s"><?php echo $board['bo_subject'] ?><span class="sound_only"> 차트</span></span>
...
<div id="calendar_basic" style="width: 100%; height: 200px; text-align: center;">Google Chart Need Online</div>
<div id="bubble_chart" style="width: 100%; height: 700px; text-align:center">Google Chart Need Online</div>
</div>
