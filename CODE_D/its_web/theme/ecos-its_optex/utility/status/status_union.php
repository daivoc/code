...
if(checkProc('node itsAPI.js')) { 
	$model = "<a href=".G5_URL.":28080>API Setup System</a>";
...
if(checkProc('node FSI.js')) { 
	$model = "<a href=".G5_URL.":52013>FSI Monitoring System</a>";
	$status_sensors .= "<tr><td class=title style=background-color:silver;>ITS FSI</td><td colspan=2 style=text-align:center;background-color:white;color:gray;>".$model."</td></tr>";
} 
if(checkProc('realtime_RLS.js')) { 
	$model = "<a href=".G5_URL.":51198>Redscan Monitoring</a>";
	$status_sensors .= "<tr><td class=title style=background-color:silver;>ITS FSI</td><td colspan=2 style=text-align:center;background-color:white;color:gray;>".$model."</td></tr>";
} 
...
.iframe_API{width:400px;height:500px;}
.iframe_peopleCount{width:280px;height:150px;}
</style>
...
if(checkProc($matchIs)) {
	$frameAddr = "http://".$_SERVER["SERVER_NAME"].":".$framePort;
	$iframeHtml .= "<div><iframe class='iframe_API' src='".$frameAddr."' frameborder='0' marginheight='0' scrolling='no' ></iframe></div>";
}
?>
