...
$cfg["model"] = $share["colorFont"]["rect"];
...
<section id="bo_w" class="container">
    ...
    <div class="tbl_wrap table-responsive">
		...
		<tr>
			<th scope="row" title="Debice ID"><label for="w_device_id"><?php echo $SK_BO_Device_Name[ITS_Lang]?><br>ID/Serial<br>Name/IP/Port</label></th>
			<td>
		...
		<tr class="w_default_tr">
			...
			<td>
				...
				<input type="text" name="" value="<?php if ($vI) echo $vI; else echo ""; ?>" id="vI" class="form-control input20P" placeholder="Intrusion" size="50">
				<input type="text" name="" value="<?php if ($vF) echo $vF; else echo ""; ?>" id="vF" class="form-control input20P" placeholder="Fault" size="50">
				<input type="text" name="" value="<?php if ($vT) echo $vT; else echo ""; ?>" id="vT" class="form-control input20P" placeholder="Temper" size="50">
				<input type="text" name="" value="<?php if ($vO) echo $vO; else echo ""; ?>" id="vO" class="form-control input20P" placeholder="Other" size="50">
				<input type="text" name="" value="<?php if ($vP) echo $vP; else echo ""; ?>" id="vP" class="form-control input20P" placeholder="Ping" size="50">
				<hr>
				Type:<br>
				...
				<input type="text" name="" value="<?php if ($tP) echo $tP; else echo ""; ?>" id="tP" class="form-control input20P" placeholder="Ping" size="50">
			</td>
		</tr>
		</tbody>
		</table>
