...
<section id="bo_w" class="container">
	...
	<div class="tbl_wrap table-responsive">
		...
		<tr class='w_detail_tr'>
			<th scope="row"><label for="w_alert_Port">Sensor<br>Info</label></th>
			<td>
			...
			<input type="text" name="w_giken_serial" value="<?php echo $write['w_giken_serial'] ?>" id="w_giken_serial" required class="form-control input10P required" placeholder="GIKEN Serial">
