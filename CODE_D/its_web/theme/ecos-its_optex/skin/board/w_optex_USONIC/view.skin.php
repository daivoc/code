...
<article id="bo_v" class="container">
    ...
    <section id="bo_v_atc" class="col-md-10 col-md-offset-1">
		...
		<tr>
			...
			<td>
				<?php echo ($DEVICE_input[$view['w_device_id']]); ?>
			</td>
		</tr>
		<tr>
		...
		<tr class="w_detail_tr">
			<th scope="row"><label for="w_alert"><?php echo $SK_BO_Alert[ITS_Lang]?></label></th>
			<td>
		...
		<tr class="w_detail_tr">
			<th scope="row" title="Time Stamp"><label for="w_keycode"><?php echo $SK_BO_License[ITS_Lang]?></label></th>
			<td>
				<?php echo $view['w_license'] ?>
			</td>
		</tr>
		<tr class="w_detail_tr">
			<th scope="row" title="Time Stamp"><label for="w_stamp"><?php echo $SK_BO_Modified[ITS_Lang]?></label></th>
			<td>
