...
// ALTER TABLE `g5_write_g200t120` 
// ADD `its_web.w_opt24` varchar(32) DEFAULT NULL AFTER `w_alert2_Value`,
// ADD `its_web.w_opt23` varchar(32) DEFAULT NULL AFTER `w_alert2_Value`,
// ADD `its_web.w_opt22` int(11) NOT NULL DEFAULT '0' AFTER `w_alert2_Value`,
// ADD `its_web.w_opt21` varchar(32) DEFAULT NULL AFTER `w_alert2_Value`,
// ADD `its_web.w_opt14` varchar(32) DEFAULT NULL AFTER `w_alert2_Value`,
// ADD `its_web.w_opt13` varchar(32) DEFAULT NULL AFTER `w_alert2_Value`,
// ADD `its_web.w_opt12` int(11) NOT NULL DEFAULT '0' AFTER `w_alert2_Value`,
// ADD `its_web.w_opt11` varchar(32) DEFAULT NULL AFTER `w_alert2_Value`;
