...
<section id="bo_w" class="container">
    ...
    <div class="tbl_wrap table-responsive">
		...
		<tr class="w_default_tr">
			...
			?>
			<th scope="row" title="Limit Due and Level"><label for="w_sensor_allow"><?php echo $SK_BO_Allowable[ITS_Lang]?></label>
			<HR>
		...
		<?php include_once($board_skin_path.'/../w_include_custom/requestWrite.php'); // Http Request ?>
