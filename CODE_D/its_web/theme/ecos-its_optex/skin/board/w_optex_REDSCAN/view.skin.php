...
$(document).ready(function(){
	...
	$('#btn_Snapshot').click(function(){
		...
		window.open("<?php echo G5_THEME_URL ?>/utility/filemanager/fm.php?ID=<?php echo $view['w_sensor_serial']?>", "File Manager", "width=800,height=400,scrollbars=no");
		return false;
	});
...
<article id="bo_v" class="container">
	...
	<div class="its_version" style="float:left;color:silver;padding:4px 8px;font-size:8pt;"><?php echo get_w_program_info(G5_CU_PATH_RLS)[0]; ?></div>
    ...
    <section id="bo_v_atc" class="col-md-10 col-md-offset-1">
		...
		*/ ?>			</tr>
		...
		<tr class="w_hide">
			<th scope="row" title="Ignore Zone"><label for="w_sensor_ignoreZone"><?php echo $SK_BO_Allowable_Diameter[ITS_Lang]?></label></th>
			<td>
				<span id="w_sensor_ignoreSDisp"><?php echo ($view['w_sensor_ignoreS'])?$view['w_sensor_ignoreS']/10:'0' ?></span> ~ <span id="w_sensor_ignoreEDisp"><?php echo ($view['w_sensor_ignoreE'])?$view['w_sensor_ignoreE']/10:'0' ?></span> <?php echo $SK_BO_Cmeter[ITS_Lang]?>
		...
		<tr class="w_hide">
			<th scope="row" title="Refuse Area"><label for="w_sensor_ignoreZone"><?php echo $SK_BO_Ignore_Area[ITS_Lang]?></label></th>
			<td>
				<span id="w_sensor_ignoreZone"><?php echo $view['w_sensor_ignoreZone'] ?></span>
			</td>
		</tr>
		<tr class="w_hide">
