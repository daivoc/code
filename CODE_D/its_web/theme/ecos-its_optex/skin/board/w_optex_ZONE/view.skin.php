...
<input type="hidden" name="w_zone_serial" value="" />
...
<article id="bo_v" class="container">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
            ...
            <?php if ($list_href) { ?><li><a href="<?php echo $list_href ?>" class="btn btn-sm btn-success"><?php echo $SK_BO_List[ITS_Lang]?></a></li><?php } ?>
            <!-- <li><a href="<?php echo $list_href ?>" class="btn btn-sm btn-success"><?php echo $SK_BO_List[ITS_Lang]?></a></li> -->
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn-sm btn-warning"><?php echo $SK_BO_New[ITS_Lang]?></a></li><?php } ?>
        </ul>
        <?php
	...
	<div style="float: right;">
        <?php echo select_w_zone_group($view['w_sns_0']); // [0] => 케이블 단선_Z2g500t200_192_168_0_91_0008rect4770g300t500_192_168_0_14_0003 ?>
    </div>
    ...
    <section id="bo_v_atc" class="">
		...
		<tbody>
		<tr>
			<th class="w_hide" scope="row"><label for="w_zone_disable"></label></th>
			<td><?php echo $SK_BO_Disable[ITS_Lang]?><input type="checkbox" class="form-control" name="w_zone_disable" id="w_zone_disable" value="1" <?php echo $view[w_zone_disable]?'checked':'';?> disabled title="Permanently Disable Sensor"></td>
		...
		<tr><?php // wr_subject w_zone_model ?>
			...
			<td>
				...
				<input type="text" name="w_zone_model" value="<?php echo $view['w_zone_model'] ?>" id="w_zone_model" readonly class="form-control input50P" size="50"></td>
			</td>
		</tr>
		<tr><?php // wr_subject w_zone_model ?>
			<th scope="row" title="Title"><label for="wr_subject">Map ID/Serial</label></th>
			<td>
				...
				<input type="text" name="w_zone_serial" value="<?php echo $view['w_zone_serial'] ?>" id="w_zone_serial" readonly class="form-control input50P" size="50"></td>
			</td>
		</tr>
		<tr><?php // w_zone_desc  ?>
			<th scope="row" title="Title"><label for="w_zone_desc">Description</label></th>
			<td>
				<input type="text" name="w_zone_desc" value="<?php echo $view['w_zone_desc'] ?>" id="w_zone_desc" readonly class="form-control input100P" size="50" maxlength="255" placeholder="Sensor Description">
			</td>
		</tr>
		</tbody>
		</table>
		...
		<tr><?php // w_sns_ ?>
			...
			<td>
			<input type="text" name="w_sns_0" value="<?php echo $view['w_sns_0'] ?>" id="w_sns_0" readonly class="form-control input50P" size="50">
			<input type="text" name="w_sns_1" value="<?php echo $view['w_sns_1'] ?>" id="w_sns_1" readonly class="hide form-control input50P" size="50">
			<input type="text" name="w_sns_2" value="<?php echo $view['w_sns_2'] ?>" id="w_sns_2" readonly class="hide form-control input50P" size="50">
			<input type="text" name="w_sns_3" value="<?php echo $view['w_sns_3'] ?>" id="w_sns_3" readonly class="hide form-control input50P" size="50">
		...
		<tr><?php // w_sns_ ?>
			...
			<input type="text" name="w_ptz_0" value="<?php echo $view['w_ptz_0'] ?>" readonly class="form-control input20P" size="50">
            <input type="checkbox" class="form-control input5P" name="w_ptzOn_0" id="w_ptzOn_0" value="1" <?php echo $view[w_ptzOn_0]?'checked':'';?> disabled>
			...
			<input type="text" name="w_ptz_1" value="<?php echo $view['w_ptz_1'] ?>" readonly class="form-control input20P" size="50">
            <input type="checkbox" class="form-control input5P" name="w_ptzOn_1" id="w_ptzOn_1" value="1" <?php echo $view[w_ptzOn_1]?'checked':'';?> disabled>
			...
			<input type="text" name="w_ptz_2" value="<?php echo $view['w_ptz_2'] ?>" readonly class="form-control input20P" size="50">
            <input type="checkbox" class="form-control input5P" name="w_ptzOn_2" id="w_ptzOn_2" value="1" <?php echo $view[w_ptzOn_2]?'checked':'';?> disabled>
			...
			<input type="text" name="w_ptz_3" value="<?php echo $view['w_ptz_3'] ?>" readonly class="form-control input20P" size="50">
            <input type="checkbox" class="form-control input5P" name="w_ptzOn_3" id="w_ptzOn_3" value="1" <?php echo $view[w_ptzOn_3]?'checked':'';?> disabled>
			</td>
		</tr>
		</tbody>
		</table>
