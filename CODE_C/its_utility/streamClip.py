...
if __name__ == '__main__':
	...
	# rtsp_stream_link = 'rtsp://root:RLS-0000@192.168.0.38/axis-media/media.amp'
	# rtsp_stream_link = 'rtsp://admin:admin@96.48.233.195:5550'
	rtsp_stream_link = 'rtsp://root:RLS-0000@192.168.168.30'
	# rtsp_stream_link = 'rtsp://admin:admin@192.168.0.110'
	# rtsp_stream_link = 0 # RPI Local Camera
