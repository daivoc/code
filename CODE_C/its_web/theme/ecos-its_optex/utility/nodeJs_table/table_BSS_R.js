...
if (noOfZone > 1) {
	// var html = fs.readFileSync('table_BSS_R.html', 'utf8');
	var html = azimuth + fs.readFileSync('table_BSS_R.txt', 'utf8');
} else {
	var html = fs.readFileSync('table_single_R.html', 'utf8');
}
...
// 소켓을 통해 자료를 table_BSS_R.html로 전송한다.
