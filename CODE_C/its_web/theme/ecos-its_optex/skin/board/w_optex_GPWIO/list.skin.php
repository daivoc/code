...
<section id="bo_list" class="container">
    ...
    <div class="tbl_head01 tbl_wrap table-responsive">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
			...
			$gpio = str_split($list[$i]['w_gpwio_cover']);
			...
			$gpio = str_split($list[$i]['w_gpwio_group']);
			for($j=0; $j<count($gpio); $j++) {
				if($gpio[$j]) {
            ...
            <td class="td_board"><?php echo $event_status[$list[$i]['w_gpwio_status']] ?></td>
