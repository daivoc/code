...
ADD `w_sensor_Addr2` varchar(32) DEFAULT NULL,
ADD `w_sensor_Port2` int(11) NOT NULL DEFAULT '0',
...
ADD `w_neighbors_ip` varchar(1024) DEFAULT NULL,
ADD `w_capacity_max` int(11) NOT NULL DEFAULT '0',
ADD `w_capacity_cur` int(11) NOT NULL DEFAULT '0',
