...
ADD `w_device_model` varchar(32) DEFAULT NULL,
ADD `w_device_serial` varchar(32) DEFAULT NULL,
ADD `w_device_ip` varchar(32) DEFAULT NULL,
ADD `w_device_port` int(11) NOT NULL DEFAULT '0',

ADD `w_device_masq` tinyint(1) NOT NULL DEFAULT '0',
ADD `w_event_id` varchar(256) DEFAULT NULL,
ADD `w_event_value` varchar(64) DEFAULT NULL,
ADD `w_event_type` varchar(64) DEFAULT NULL,
