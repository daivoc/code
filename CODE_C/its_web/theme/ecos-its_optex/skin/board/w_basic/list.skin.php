...
<section id="bo_list" class="container">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn-sm btn-primary">등록</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap table-responsive">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_board"><?php echo $list[$i]['w_device_id'] ?></td>
            <td class="td_board"><?php echo $list[$i]['w_sensor_ignore'] ?></td>
            <td class="td_board"><?php echo $list[$i]['w_sensor_face'] ?></td>
            <td class="td_name sv_use"><?php echo $list[$i]['name'] ?></td>
            <td class="td_date"><?php echo $list[$i]['datetime2'] ?></td>
            <td class="td_num" onclick='window.open("<?php echo $board_skin_url?>/mapsInfo.php?myLatS=<?php echo $list[$i]['w_sensor_lat_s']?>&myLngS=<?php echo $list[$i]['w_sensor_lng_s']?>&myLatE=<?php echo $list[$i]['w_sensor_lat_e']?>&myLngE=<?php echo $list[$i]['w_sensor_lng_e']?>","mapsLocation", "width=600,height=400,scrollbars=no");' >보기</td>
