	...
	<section id="bo_v_atc" class="col-md-10 col-md-offset-1">
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="w_device_name" value="<?php echo $view['w_device_name'] ?>" id="w_device_name" disabled class="form-control input25P">
		...
		<tr>
			...
			<td>
			<input type="hidden" name="w_id" value="<?php echo $view['w_id'] ?>" id="w_id" readonly class="form-control input25P">
			<input type="text" name="w_parent_id" value="<?php echo $view['w_parent_id'] ?>" id="w_parent_id" readonly class="form-control input25P">
			<input type="text" name="w_zone_id" value="<?php echo $view['w_zone_id'] ?>" id="w_zone_id" readonly class="form-control input25P">
			<input type="text" name="w_zone_name" value="<?php echo $view['w_zone_name'] ?>" id="w_zone_name" readonly class="form-control input25P">
			<input type="text" name="w_system_ip" value="<?php echo $view['w_system_ip'] ?>" id="w_system_ip" readonly class="form-control input25P">
			</td>
		</tr>
		</tbody>
		</table>
