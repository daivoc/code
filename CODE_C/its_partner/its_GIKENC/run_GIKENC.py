...
def main():
	...
	for row in tableRow:
		...
		cfg['face_direction'] = [0,0,0,0,0,0,0,0]
		if row['w_face_direction_A'] == 1:
			cfg['face_direction'][0] = 1
		elif  row['w_face_direction_A'] == 2:
			cfg['face_direction'][1] = 1
		elif  row['w_face_direction_A'] == 3:
			cfg['face_direction'][0] = 1
			cfg['face_direction'][1] = 1
		else:
			pass

		if row['w_face_direction_B'] == 1:
			cfg['face_direction'][2] = 1
		elif  row['w_face_direction_B'] == 2:
			cfg['face_direction'][3] = 1
		elif  row['w_face_direction_B'] == 3:
			cfg['face_direction'][2] = 1
			cfg['face_direction'][3] = 1
		else:
			pass
		
		if row['w_face_direction_C'] == 1:
			cfg['face_direction'][4] = 1
		elif  row['w_face_direction_C'] == 2:
			cfg['face_direction'][5] = 1
		elif  row['w_face_direction_C'] == 3:
			cfg['face_direction'][4] = 1
			cfg['face_direction'][5] = 1
		else:
			pass
		
		if row['w_face_direction_D'] == 1:
			cfg['face_direction'][6] = 1
		elif  row['w_face_direction_D'] == 2:
			cfg['face_direction'][7] = 1
		elif  row['w_face_direction_D'] == 3:
			cfg['face_direction'][6] = 1
			cfg['face_direction'][7] = 1
		else:
			pass
		
		# cfg['face_direction']['A']  = row['w_face_direction_A']
		# cfg['face_direction']['B']  = row['w_face_direction_B']
		# cfg['face_direction']['C']  = row['w_face_direction_C']
		# cfg['face_direction']['D']  = row['w_face_direction_D']
		...
		cfg['its']['userURL']         = cfg['its']['bo_ip']+share['path']['user']['home']
		...
		cfg['log_table'] = {}
		# cfg['log_table']['tbl_log']  = 'w_log_sensor_'+row['w_sensor_serial']
		cfg['log_table']['tbl_live']  = 'w_log_gikenC_live_'+row['w_giken_serial']
		cfg['log_table']['tbl_min']   = 'w_log_gikenC_min_'+row['w_giken_serial']
		cfg['log_table']['tbl_hour']  = 'w_log_gikenC_hour_'+row['w_giken_serial']
		cfg['log_table']['tbl_day']   = 'w_log_gikenC_day_'+row['w_giken_serial']
		cfg['log_table']['tbl_week']  = 'w_log_gikenC_week_'+row['w_giken_serial']
		cfg['log_table']['tbl_month'] = 'w_log_gikenC_month_'+row['w_giken_serial']
		cfg['log_table']['tbl_sum']   = 'w_log_gikenC_sum_'+row['w_giken_serial']
		cfg['log_table']['tbl_life']  = '90' # days 이후 삭제
		...
		print('Sensor MASQUERADE: http://localhost:{}'.format(MASQUERADE(True, cfg['interface']['port_MQ'])))
		print('IP:{}, Port:{}, Version:{}, Serial:{}'.format(cfg['sensor']['ip'], cfg['sensor']['port'], cfg['sensor']['version'], cfg['sensor']['serial']))
